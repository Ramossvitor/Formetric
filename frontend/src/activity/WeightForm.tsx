      ...
      <div className="activity-form-grid">
        ...
        <div className="field-group activity-full-field">
          ...
          <div className="number-with-unit">
            <input disabled={detailsDisabled} id="weight-value" min="1" onChange={(event) => setForm((current) => ({ ...current, weightKg: event.target.value }))} required step="0.01" inputMode="decimal" type="number" value={form.weightKg} />
            <span>kg</span>
          </div>
        </div>
        {form.existing && !entry ? (
