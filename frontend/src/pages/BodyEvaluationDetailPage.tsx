...
export function BodyEvaluationDetailPage() {
  const { id = '' } = useParams(); const [editingVersion, setEditingVersion] = useState<BodyEvaluationVersion | null>(null); const [viewingVersionId, setViewingVersionId] = useState<string | null>(null); const queryClient = useQueryClient(); const evaluation = useQuery(bodyEvaluationQuery(id))
